...
public class SetCovering {
    ...
    public static void main(String[] args) {
        Set<String> statesNeeded = new HashSet(asList("mt", "wa", "or", "id", "nv", "ut", "ca", "az"));
        Map<String, Set<String>> stations = new LinkedHashMap<>();

        stations.put("kone", new HashSet<>(asList("id", "nv", "ut")));
        stations.put("ktwo", new HashSet<>(asList("wa", "id", "mt")));
        stations.put("kthree", new HashSet<>(asList("or", "nv", "ca")));
        stations.put("kfour", new HashSet<>(asList("nv", "ut")));
        stations.put("kfive", new HashSet<>(asList("ca", "az")));
